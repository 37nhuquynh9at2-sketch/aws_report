...
### [Blog 1 - TỰ ĐỘNG HÓA QUẢN LÝ DỮ LIỆU: TRIỂN KHAI HỆ THỐNG BACKUP & RESTORE TOÀN DIỆN TRÊN AWS](3.1-Blog1/)
...
### [Blog 2 - AMAZON DYNAMODB – DỊCH VỤ CƠ SỞ DỮ LIỆU NOSQL CỦA AWS DÀNH CHO ỨNG DỤNG HIỆN ĐẠI](3.2-Blog2/)
Blog này chia sẻ những kiến thức và trải nghiệm của mình sau quá trình tìm hiểu **Amazon DynamoDB**. Nội dung tập trung giới thiệu các đặc điểm nổi bật của DynamoDB như mô hình **NoSQL**, dịch vụ **Fully Managed**, khả năng mở rộng tự động, hiệu năng cao với độ trễ thấp và mô hình thanh toán theo mức sử dụng. Đồng thời, bài viết cũng trình bày tư duy thiết kế dữ liệu trong DynamoDB và mối liên hệ giữa DynamoDB với các dịch vụ AWS khác như **IAM, CloudWatch** và **AWS Backup** trong việc xây dựng các ứng dụng hiện đại.
